...
// --- IMPORT GAMBAR FITUR DI SINI (Contoh) ---
...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "'MediChat' dirancang untuk memberikan pengalaman percakapan kesehatan yang aman, nyaman, dan bertanggung jawab. Setiap informasi dan panduan yang Anda terima disaring dari sumber medis terpercaya seperti jurnal ilmiah, data WHO, dan panduan klinis terkini, bukan dari asumsi AI semata. MediChat memastikan interaksi Anda didasarkan pada pengetahuan medis yang tervalidasi."
    },
  ];
      ...
      <div className="container">
        ...
        <div className="features-grid">
          {features.map((feature, index) => (
            <div 
              className={`feature-card feature-card-${index % 2 === 0 ? 'left' : 'right'}-image`} 
              key={index}
            >
